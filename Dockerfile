...
ADD files_before_after_diff.txt .
ADD files_before_after_uninstall_diff.txt .
...
RUN \
    ...
    diff files_before_after_diff.txt install_diff.txt; \
    diff files_before_after_uninstall_diff.txt uninstall_diff.txt
